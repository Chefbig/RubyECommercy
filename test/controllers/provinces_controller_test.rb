...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { gst: @province.gst, hst: @province.hst, name: @province.name, pst: @province.pst, qst: @province.qst } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { gst: @province.gst, hst: @province.hst, name: @province.name, pst: @province.pst, qst: @province.qst } }
